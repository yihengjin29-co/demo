...
export const seedInstitutions = (): Institution[] => [
  ...
  makeInstitution({ id: 'inst-amc', name: '国际申信', shortName: '国际申信', type: '金融组织', establishedAt: '2015-06-18', registeredCapital: '100.00亿元', creditCode: '91310000342188721X', ownership: '集团控股金融组织', businessScope: '不良资产收购处置、重组重整、特殊机会投资及咨询服务。', management: '设董事会风险委员会和独立风险管理部门。', branches: '设华东、华南及华北业务中心。', address: '上海市黄浦区', website: 'www.international-shenxin.example', emergencyContact: '王经理', phone: '021-60000001', includedAt: '2021-07-01', status: '已纳入', activeIndicatorCount: 31, warningCount: 2, overview: '专注特殊资产管理和风险化解，承担集团风险资产专业处置职能。' }, 1),
