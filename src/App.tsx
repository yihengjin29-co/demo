...
const menus: MenuItem[] = [
  ...
  { label: '风险限额管理', icon: '▥', children: [
    ...
    { label: '风险限额回检', path: '/limits/backtrack' },
  ] },
...
function App() {
  ...
  const render = () => {
    ...
    if (path === '/limits/backtrack') return <IndicatorQuery state={state} role={role} navigate={navigate} update={update} toast={toast} title="风险限额回检" />;
